    ...
    <SafeAreaView className='bg-primary h-full'>
      <ScrollView>
        <View className='w-full justify-center  min-h-[85vh] px-4 my-6'>
          ...
          <Text className='text-3xl text-white text-bold mt-10'>Sign up to Aora</Text>
          ...
          <CustomButton title='Sign up' handlePress={submit} containerStyles='mt-14' isLoading={isSubmitting}/>
          <View className='justify-center pt-5 flex-row gap-2'>
            <Text className='text-lg text-gray-100'>Have an account already?</Text>
            <Link href='/sign-in' className='text-lg text-secondary font-bold'>Sign In</Link>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
